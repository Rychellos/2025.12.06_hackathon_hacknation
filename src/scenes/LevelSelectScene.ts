...
export class LevelSelectScene extends Container {
    ...
    private createBackground(): void {
        ...
        this.background.fill({ color: 0x2c3e50 }); // Darker slate
    ...
    private createPath(): void {
        ...
        const p1 = { x: w * 0.3, y: h * 0.75 };
        const p2 = { x: w * 0.7, y: h * 0.5 };
        const p3 = { x: w * 0.4, y: h * 0.25 };
        ...
        this.pathLayer.stroke({ width: 20, color: 0x34495e, cap: 'round', join: 'round' });
    ...
    private createNodes(): void {
        ...
        const levels = [
            { id: 1, x: w * 0.3, y: h * 0.75, unlocked: true },
            { id: 2, x: w * 0.7, y: h * 0.5, unlocked: true },
            { id: 3, x: w * 0.4, y: h * 0.25, unlocked: true },
        ];
    ...
    private createLevelNode(id: number, x: number, y: number, unlocked: boolean): void {
