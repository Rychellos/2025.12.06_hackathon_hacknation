import { Application, Container, Text, TextStyle, Graphics, Sprite } from "pixi.js";
...
export class CombatScene extends Container {
    ...
    private createBackground(): void {
        ...
        floor.ellipse(this.app.screen.width * 0.75, this.app.screen.height * 0.4, 300, 100);
    ...
    private createUI(): void {
        ...
        this.resultText.position.set(this.app.screen.width / 2, this.app.screen.height / 2 - 50);
        ...
        this.choiceText = new Text({ text: 'Choose your move...', style: choiceStyle });
